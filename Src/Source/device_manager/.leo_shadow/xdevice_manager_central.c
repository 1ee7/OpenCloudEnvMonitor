//@+leo-ver=4-thin
//@+node:gan0ling.20140624153650.1511:@shadow device_manager_central.c
//@@language c
//@@tabwidth -4
//@+others
//@+node:gan0ling.20140624200607.3336:device_manager_central declarations
...
//@nonl
//@-node:gan0ling.20140624200607.3336:device_manager_central declarations
//@+node:gan0ling.20140624200607.3337:sizeof
...
//@-node:gan0ling.20140624200607.3337:sizeof
//@+node:gan0ling.20140624200607.3338:sizeof
...
//@-node:gan0ling.20140624200607.3338:sizeof
//@+node:gan0ling.20140624200607.3339:sizeof
...
//@-node:gan0ling.20140624200607.3339:sizeof
//@+node:gan0ling.20140624200607.3340:application_instance_init
...
//@-node:gan0ling.20140624200607.3340:application_instance_init
//@+node:gan0ling.20140624200607.3341:connection_instance_init
...
//@-node:gan0ling.20140624200607.3341:connection_instance_init
//@+node:gan0ling.20140624200607.3342:peer_instance_init
...
//@-node:gan0ling.20140624200607.3342:peer_instance_init
//@+node:gan0ling.20140624200607.3343:connection_instance_find
...
//@-node:gan0ling.20140624200607.3343:connection_instance_find
//@+node:gan0ling.20140624200607.3344:device_instance_allocate
...
//@-node:gan0ling.20140624200607.3344:device_instance_allocate
//@+node:gan0ling.20140624200607.3345:device_instance_free
...
//@-node:gan0ling.20140624200607.3345:device_instance_free
//@+node:gan0ling.20140624200607.3346:device_instance_find
...
static api_result_t device_instance_find(ble_gap_addr_t * p_addr, uint32_t * p_device_index)
{
    ...
    for (index = 0; index < DEVICE_MANAGER_MAX_BONDS; index ++)
    {
        ...
        if ((memcmp(m_peer_table[index].peer_id.id_addr_info.addr, p_addr->addr, sizeof(BLE_GAP_ADDR_LEN)) == 0) &&
           (m_peer_table[index].peer_id.id_addr_info.addr_type == p_addr->addr_type))
        {
...
//@-node:gan0ling.20140624200607.3346:device_instance_find
//@+node:gan0ling.20140624200607.3347:app_evt_notify
...
//@-node:gan0ling.20140624200607.3347:app_evt_notify
//@+node:gan0ling.20140624200607.3348:app_dev_evt_notify
...
//@-node:gan0ling.20140624200607.3348:app_dev_evt_notify
//@+node:gan0ling.20140624200607.3349:connection_instance_alloc
...
//@-node:gan0ling.20140624200607.3349:connection_instance_alloc
//@+node:gan0ling.20140624200607.3350:connection_instance_free
...
//@-node:gan0ling.20140624200607.3350:connection_instance_free
//@+node:gan0ling.20140624200607.3351:dummy_handler
...
//@-node:gan0ling.20140624200607.3351:dummy_handler
//@+node:gan0ling.20140624200607.3352:device_context_store
...
//@-node:gan0ling.20140624200607.3352:device_context_store
//@+node:gan0ling.20140624200607.3353:no_service_context_store
...
//@-node:gan0ling.20140624200607.3353:no_service_context_store
//@+node:gan0ling.20140624200607.3354:gatts_context_store
...
//@-node:gan0ling.20140624200607.3354:gatts_context_store
//@+node:gan0ling.20140624200607.3355:gattc_context_store
...
//@-node:gan0ling.20140624200607.3355:gattc_context_store
//@+node:gan0ling.20140624200607.3356:gattsc_context_store
...
//@-node:gan0ling.20140624200607.3356:gattsc_context_store
//@+node:gan0ling.20140624200607.3357:no_service_context_load
...
//@-node:gan0ling.20140624200607.3357:no_service_context_load
//@+node:gan0ling.20140624200607.3358:gatts_context_load
                                                ...
                                                dm_handle_t const       * p_handle)
{
   api_result_t retval = pstorage_load((uint8_t *)&m_service_table[p_handle->connection_id],
    ...
    if(retval == NRF_SUCCESS)
    {
        ...
        if (m_service_table[p_handle->connection_id].gatts_context.size == 0xFFFF)
        {
...
//@-node:gan0ling.20140624200607.3358:gatts_context_load
//@+node:gan0ling.20140624200607.3359:gattc_context_load
...
//@-node:gan0ling.20140624200607.3359:gattc_context_load
//@+node:gan0ling.20140624200607.3360:gattsc_context_load
...
//@-node:gan0ling.20140624200607.3360:gattsc_context_load
//@+node:gan0ling.20140624200607.3361:no_service_context_apply
...
//@-node:gan0ling.20140624200607.3361:no_service_context_apply
//@+node:gan0ling.20140624200607.3362:gatts_context_apply
...
//@-node:gan0ling.20140624200607.3362:gatts_context_apply
//@+node:gan0ling.20140624200607.3363:gattc_context_apply
...
//@-node:gan0ling.20140624200607.3363:gattc_context_apply
//@+node:gan0ling.20140624200607.3364:gattsc_context_apply
...
//@-node:gan0ling.20140624200607.3364:gattsc_context_apply
//@+node:gan0ling.20140624200607.3365:initiate_security_request
...
uint32_t initiate_security_request(const dm_handle_t * p_handle)
{
    ...
    DM_DUMP((uint8_t *)&m_application_table[p_handle->appl_id].sec_param, sizeof(ble_gap_sec_params_t));
...
//@-node:gan0ling.20140624200607.3365:initiate_security_request
//@+node:gan0ling.20140624200607.3366:dm_pstorage_cb_handler
...
//@-node:gan0ling.20140624200607.3366:dm_pstorage_cb_handler
//@+node:gan0ling.20140624200607.3367:dm_init
...
//@-node:gan0ling.20140624200607.3367:dm_init
//@+node:gan0ling.20140624200607.3368:dm_register
...
//@-node:gan0ling.20140624200607.3368:dm_register
//@+node:gan0ling.20140624200607.3369:dm_security_setup_req
...
api_result_t dm_security_setup_req(dm_handle_t * p_handle)
{
    ...
    {
        if (p_handle->device_id != INVALID_ID)
        {
        ...
        else
        {
            ...
            retval = device_instance_allocate(&device_index, &m_connection_table[p_handle->connection_id].peer_addr);
            if (retval == NRF_SUCCESS)
            {
...
//@-node:gan0ling.20140624200607.3369:dm_security_setup_req
//@+node:gan0ling.20140624200607.3370:dm_security_status_req
...
//@-node:gan0ling.20140624200607.3370:dm_security_status_req
//@+node:gan0ling.20140624200607.3371:dm_whitelist_create
...
//@-node:gan0ling.20140624200607.3371:dm_whitelist_create
//@+node:gan0ling.20140624200607.3372:dm_handle_initialize
...
//@-node:gan0ling.20140624200607.3372:dm_handle_initialize
//@+node:gan0ling.20140624200607.3373:dm_device_add
                           ...
                           dm_device_context_t const    * p_context)
{
    ...
    retval = device_instance_allocate(&p_handle->device_id,&p_peer_id->peer_id.id_addr_info);
    if (retval == NRF_SUCCESS)
    {
        pstorage_handle_t block_handle;
...
//@-node:gan0ling.20140624200607.3373:dm_device_add
//@+node:gan0ling.20140624200607.3374:dm_device_delete
...
//@-node:gan0ling.20140624200607.3374:dm_device_delete
//@+node:gan0ling.20140624200607.3375:dm_device_delete_all
...
//@-node:gan0ling.20140624200607.3375:dm_device_delete_all
//@+node:gan0ling.20140624200607.3376:dm_service_context_set
...
//@-node:gan0ling.20140624200607.3376:dm_service_context_set
//@+node:gan0ling.20140624200607.3377:dm_service_context_get
...
//@-node:gan0ling.20140624200607.3377:dm_service_context_get
//@+node:gan0ling.20140624200607.3378:dm_service_context_delete
...
//@-node:gan0ling.20140624200607.3378:dm_service_context_delete
//@+node:gan0ling.20140624200607.3379:dm_application_context_set
...
//@-node:gan0ling.20140624200607.3379:dm_application_context_set
//@+node:gan0ling.20140624200607.3380:dm_application_context_get
...
//@-node:gan0ling.20140624200607.3380:dm_application_context_get
//@+node:gan0ling.20140624200607.3381:dm_application_context_delete
...
//@-node:gan0ling.20140624200607.3381:dm_application_context_delete
//@+node:gan0ling.20140624200607.3382:dm_peer_addr_set
...
//@-node:gan0ling.20140624200607.3382:dm_peer_addr_set
//@+node:gan0ling.20140624200607.3383:dm_peer_addr_get
...
//@-node:gan0ling.20140624200607.3383:dm_peer_addr_get
//@+node:gan0ling.20140624200607.3384:dm_ble_evt_handler
...
void dm_ble_evt_handler(ble_evt_t    * p_ble_evt)
{
    ...
    switch (p_ble_evt->header.evt_id)
    {
        ...
        case BLE_GAP_EVT_SEC_PARAMS_REQUEST:
            ...
            keys_exchanged.keys_periph.p_id_key    = &m_peer_table[m_connection_table[index].bonded_dev_id].peer_id;
        ...
        case BLE_GAP_EVT_AUTH_STATUS:
        {
            ...
            else
            {
                ...
                {
                    if (handle.device_id != INVALID_PEER_INDEX)
                    {
                        m_connection_table[index].state |= BONDED;
        ...
        case BLE_GAP_EVT_SEC_REQUEST:
            ...
            // Security request from slave, authenticate or encrypt.
            if ((m_application_table[0].state & CONTROL_PROCEDURE_IN_PROGRESS) ==
                 CONTROL_PROCEDURE_IN_PROGRESS)
            {
                DM_LOG("[DM]: Marked pending.\r\n");
                m_connection_table[index].state |= PAIRING_PENDING;
            ...
            {
                retval = initiate_security_request(&handle);
            }
            break;
        default:
            break;
    ...
    if (start_sec_procedure)
    {
        if ((m_application_table[0].state & QUEUED_CONTROL_REQUEST) == QUEUED_CONTROL_REQUEST)
        {
            ...
            retval = connection_instance_find(BLE_CONN_HANDLE_INVALID, PAIRING_PENDING, &pending_index);
            if (retval == NRF_SUCCESS)
            {
